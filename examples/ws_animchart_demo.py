...
which is a good example of how the range will look when this happens during a brick formation.
'''
...
r = RangeWS(initial_timestamp, initial_price, 0.04)
...
def animate(ival):
    ...
    df_wicks = r.range_animate('normal', max_len=100, keep=50)

    ax1.clear()
    ax2.clear()

    mpf.plot(df_wicks, type='candle', ax=ax1, volume=ax2, axtitle='range: normal')
